...
在调用 `Arctern Restful API` 之前请先启动服务，具体步骤详见[服务器启动](./README.md)。
...
![带权点图weighted_pointmap](png/weighted_pointmap.png)。
...
![轮廓图choroplethmap.png](png/choroplethmap.png)
